...
public class CP_05_DatosCobertura {
  ...
  String NombreReporte, TestCaptura, baseUrl, ScreenShot_Path, tag1, Msj, URLInicial;
...
@BeforeClass(alwaysRun = true)
 ...
 @Test
  public void T06_DatosCobertura() throws Exception {
	...
	AssertJUnit.assertEquals(LeerExcel.GetData(0, 12, 5), tag1);
	
	
	//Tomar Screen
	ScreenShot_Path= "<img src="+ CaptureScreenshot.ScreenShot(driver, TestCaptura) + ">"; 
    TestBPM.log(LogStatus.INFO, "Finalizo la prueba T06 Datos Cobertura");
